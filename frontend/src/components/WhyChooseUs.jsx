...
export default function WhyChooseUs() {
  return (
    <section className="grid grid-cols-12 sm:min-h-[calc(100vh-3.625rem)]">
      <div className="col-span-12 my-5">
        <h2 className="text-center text-xl sm:text-2xl md:text-3xl sm:font-bold">
          Why Choose Us?{" "}
        </h2>
      ...
      {/* Left Content */}
      <div className="col-span-12 md:col-span-4 lg:col-span-6 my-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-5 md:gap-8">
          {[
            ...
            <div key={index}>
              ...
              <p className="text-justify lg:text-left">{item.description}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Right Content */}
      <div className="col-span-12 md:col-span-8 lg:col-span-6 grid grid-cols-2 grid-rows-9 gap-2 px-4">
